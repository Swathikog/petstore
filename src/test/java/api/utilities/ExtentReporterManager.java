...
public class ExtentReporterManager implements ITestListener {
	...
	public void onStart(ITestContext testContext)
	{
		...
		sparkReporter.config().setReportName("Pet store usrs API");//name of the report
		...
		extent.setSystemInfo("user", "swathi");
	...
	public void onFinish(ITestContext testccontext)
	{
		extent.flush();
	}
}
